...
function buildBillHtml(invoice: Invoice, tenant: TenantSummary, party: Party): string {
  ...
  const logoHtml = tenant.logoUrl
    ? `<img src="${tenant.logoUrl}" style="max-height:64px;max-width:84px;object-fit:contain;" />`
  ...
  const sigHtml = tenant.signatureUrl
    ? `<img src="${tenant.signatureUrl}" style="max-height:64px;max-width:160px;object-fit:contain;display:block;margin:0 auto 4px;" />`
