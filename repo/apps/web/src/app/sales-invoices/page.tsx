...
export default async function SalesInvoicesPage() {
  ...
  return (
    <AppShell
      ...
      actions={
        <Link href="/sales-invoices/new" className="inline-flex items-center gap-2 rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-emerald-700">
          + New invoice
        </Link>
      }
    >
