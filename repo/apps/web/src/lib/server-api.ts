...
export const serverApi = {
  ...
  getSalesInvoice:   (id: string) => serverGet<Invoice>(`/sales-invoices/${id}`),
  getPurchaseInvoice: (id: string) => serverGet<Invoice>(`/purchase-invoices/${id}`),
  getParty:          (id: string) => serverGet<Party>(`/parties/${id}`),
